  ...
  return (
    ...
    >
      <Link
        ...
        state={{ judgment }}
        className="relative flex flex-col h-full p-5 rounded-2xl bg-white dark:bg-[#1e293b] border border-slate-200/80 dark:border-slate-800 hover:border-blue-500/50 dark:hover:border-blue-400/50 hover:shadow-xl hover:shadow-blue-500/10 transition-all duration-300 group overflow-hidden"
      >
        {/* Top row */}
        ...
        {/* Title */}
        <h3 className="font-bold text-slate-900 dark:text-white text-base leading-snug group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors line-clamp-2 mb-1">
          {judgment.title}
        </h3>
