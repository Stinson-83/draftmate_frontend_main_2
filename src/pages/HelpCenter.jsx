                    ...
                    <div className="flex flex-col px-2 pb-4">
                        ...
                        <details className="group border-b border-gray-50 dark:border-gray-800 last:border-0">
                            <summary className="flex items-center justify-between p-3 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800/50 rounded-lg transition-colors list-none">
                                <span className="text-sm font-medium text-gray-700 dark:text-gray-300">How to reset my password?</span>
                            ...
                            <div className="px-3 pb-4 pt-1">
                                <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
                                    Go to the login page and click "Forgot Password". We'll send a secure link to your registered email address to create a new one.
                                </p>
                            </div>
                        </details>
                        ...
                        <details className="group border-b border-gray-50 dark:border-gray-800 last:border-0">
                            <summary className="flex items-center justify-between p-3 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800/50 rounded-lg transition-colors list-none">
                                <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Is my data secure?</span>
                                <span className="material-symbols-outlined text-gray-400 text-[20px] transition-transform duration-200 chevron-icon">expand_more</span>
                            </summary>
                            <div className="px-3 pb-4 pt-1">
                                <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
                                    Yes, we use industry-standard AES-256 encryption for all data at rest and TLS for data in transit. Your security is our top priority.
                                </p>
                            </div>
                        </details>
                        ...
                        <details className="group border-b border-gray-50 dark:border-gray-800 last:border-0">
                            <summary className="flex items-center justify-between p-3 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800/50 rounded-lg transition-colors list-none">
                                <span className="text-sm font-medium text-gray-700 dark:text-gray-300">How do I change my billing?</span>
                                <span className="material-symbols-outlined text-gray-400 text-[20px] transition-transform duration-200 chevron-icon">expand_more</span>
                            </summary>
                            <div className="px-3 pb-4 pt-1">
                                <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
                                    You can update your payment methods and subscription details under the "Billing" tab in your account settings.
                                </p>
                            </div>
                        </details>
                        ...
                        <details className="group border-b border-gray-50 dark:border-gray-800 last:border-0">
                            <summary className="flex items-center justify-between p-3 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800/50 rounded-lg transition-colors list-none">
                                <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Can I export my files?</span>
                                <span className="material-symbols-outlined text-gray-400 text-[20px] transition-transform duration-200 chevron-icon">expand_more</span>
                            </summary>
                            <div className="px-3 pb-4 pt-1">
                                <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
                                    Absolutely. All your documents can be exported in PDF or DOCX format at any time from the dashboard.
                                </p>
                            </div>
                        </details>
