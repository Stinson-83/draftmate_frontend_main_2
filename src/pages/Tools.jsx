...
const Tools = () => {
    ...
    // ════════ TOOL CARD ════════
    const ToolCard = ({ icon, title, description, onClick, accentColor, badge }) => {
        ...
        return (
            ...
            >
                ...
                <motion.div
                    className="relative z-10 flex items-center gap-1.5 text-sm font-semibold mt-2"
    ...
    return (
        <div className="flex-1 flex flex-col h-full min-w-0 overflow-hidden bg-background-light dark:bg-background-dark font-display relative">
            <div className="flex-1 relative z-10 overflow-y-auto pb-20">
                <div className="w-full max-w-[1200px] mx-auto px-4 md:px-10 lg:px-20 pt-10 pb-12">
                    ...
                    >
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <h1 className="text-2xl md:text-3xl font-bold text-[#0d131b] dark:text-white">
                                Tools
                            </h1>
                        </div>
                        <p className="text-sm text-slate-500 dark:text-slate-400 ml-13">
                            Everything you need to speed up your legal workflow
                        </p>
                    </motion.div>
