"""
Legal Draft Generator Bot using Google Gemini Free LLM
========================================================
An agentic bot that generates legal drafts from case context and legal documents.
"""
...
# ============================================================
# Get your free API key from: https://aistudio.google.com/app/api
...
"""
DEFAULT_API_KEY = "AIzaSyCfL5GbGuDAvj8vSMODxPeaiNVUcPy7flI"
...
if __name__ == "__main__":
    # Example case context with some missing information
    example_case_context = """
    PARTIES:
    - Plaintiff: Rajesh Kumar, age 45 years
    - Defendant: XYZ Private Limited (a company registered under Companies Act)
    
    NATURE OF DISPUTE: Wrongful termination from employment
    
    FACTS:
    1. The Plaintiff was employed as Chief Technology Officer at XYZ Private Limited
    2. Employment commenced on 1st January 2020
    3. The Plaintiff was terminated on 30th November 2024 without prior notice
    4. No termination letter was provided
    5. Salary for the months of October and November 2024 remains unpaid
    6. The Plaintiff had no disciplinary issues during the tenure
    
    RELIEF SOUGHT:
    1. Payment of pending salary for 2 months
    2. Compensation equivalent to 3 months salary in lieu of notice
    3. Release of full and final settlement
    4. Legal costs
    
    APPLICABLE LAW: Indian Contract Act, 1872 and applicable labor laws
    """
    
    example_reference_doc = """
    Section 14 of the Specific Relief Act, 1963 - Contracts not specifically enforceable
    Section 73 of the Indian Contract Act, 1872 - Compensation for loss or damage caused by breach of contract
    """
    
    print("=" * 60)
    print("LEGAL DRAFT GENERATOR - Example Usage")
    print("=" * 60)
    print("\nCase Context:")
    print(example_case_context)
    print("\nReference Documents:")
    print(example_reference_doc)
    print("\n" + "=" * 60)
    print("To generate the draft, run:")
    print("=" * 60)


    draft = generate_legal_draft(
        case_context=example_case_context,
        legal_documents=example_reference_doc,
        document_type="Legal Notice",
    )
    print(draft)
