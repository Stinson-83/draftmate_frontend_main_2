"""
Legal Draft Plain HTML Generator
Generates legal drafts as plain HTML with all content in text-span elements.
No formatting (bold, italics, highlights) - just clean text content.
"""
