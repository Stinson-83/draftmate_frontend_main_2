    ...
    function formatLegalDocumentHtml(text) {
        ...
        function flushPara() {
            ...
            if (labelMatch) {
                ...
                htmlBlocks.push(
                    '<p style="line-height: 1.5; color: #111827; margin-top: 3pt; margin-bottom: 4pt;">' +
            ...
            if (isHeadingLine(paraText)) {
                ...
                htmlBlocks.push(
                    '<h3 style="font-weight: bold; color: #000000; margin-top: 10pt; margin-bottom: 4pt; line-height: 1.3;">' +
                    formattedHeader +
                    '</h3>'
                );
                return;
            ...
            htmlBlocks.push(
                '<p style="line-height: 1.5; color: #111827; margin-top: 0pt; margin-bottom: 8pt; text-align: justify;">' +
                formattedBody +
                '</p>'
            );
        }
